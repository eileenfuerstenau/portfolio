...
export default function Headline() {
  return (
    <div className="bg-hero flex-col overflow-hidden relative flex min-h-[250px] sm:min-h-[120px] w-full justify-center items-center max-md:max-w-full max-md:px-5">
